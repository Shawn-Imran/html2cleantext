...
html2cleantext input.html --no-strip-boilerplate
```
...
- `strip_boilerplate` (bool): Remove boilerplate content (default: True)
...
optional arguments:
  ...
  --strip-boilerplate   Remove navigation, footers, and boilerplate content
...
html2cleantext raw.html --no-strip-boilerplate --output raw_content.md
